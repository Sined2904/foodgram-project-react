...
from recipes.models import Ingredient, Tag, Recipe, Favourites, Shopping_list, IngredientInRecipe
...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def get_is_favorited(self, obj):
        ...
        return Favourites.objects.filter(recipe=obj, user=request.user).exists()
...
class SubscribeSerializer(serializers.ModelSerializer):
    ...
    def get_is_subscribed(self, obj):
        ...
        if request.user.is_anonymous:
            return False
        return Follow.objects.filter(author=obj.author, user=request.user).exists()
